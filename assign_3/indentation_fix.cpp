...
void indent(const string &inputFileName, const string &outputFileName) {
    ...
    while (getline(inputFile, line)) {
        ...
        for (int i = 0; i < tab; i++) {
            outputFile << "    ";  // adjust the number of spaces for each level of indentation
        }
...
int main() {
    const string inputFileName = "unindented_file_for_indentation_fix.cpp";  
    const string outputFileName = "Indent.cpp";
